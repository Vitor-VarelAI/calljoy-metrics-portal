          ...
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-xs text-[hsl(160,70%,45%)]">+2% vs ontem</p>
              </div>
              <div className="rounded-full bg-[hsl(160,70%,45%)]/10 p-2">
                <Smile className="h-6 w-6 text-[hsl(160,70%,45%)]" />
              </div>
            </div>
          </CardContent>
        </Card>
          ...
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-xs text-[hsl(0,70%,50%)]">+3 vs ontem</p>
              </div>
              <div className="rounded-full bg-[hsl(0,70%,50%)]/10 p-2">
                <AlertTriangle className="h-6 w-6 text-[hsl(0,70%,50%)]" />
              </div>
            </div>
          </CardContent>
        </Card>
          ...
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-3xl font-bold">06:21</p>
                <p className="text-xs text-muted-foreground">-12s vs ontem</p>
              </div>
              <div className="rounded-full bg-primary/10 p-2">
